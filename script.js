document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateField(field) {
    ...
    if (field.hasAttribute('minlength')) {
      ...
      if (value.length < min) {
        showFieldError(field, field.dataset.errorMinlength || 'Minimum ' + min + ' characters required.');
        return false;
      }
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '368f6354-cfc1-4cc4-9f49-f59fbe8117c4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '368f6354-cfc1-4cc4-9f49-f59fbe8117c4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '368f6354-cfc1-4cc4-9f49-f59fbe8117c4';
